              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: Semantics(
                      label: AppLocalizations.of(context)!.termsVisitButton,
                      button: true,
                  ...
                  SizedBox(
                    ...
                    width: double.infinity,
                    child: Semantics(
                      label: AppLocalizations.of(context)!.termsEmailButton,
                      button: true,
                  ...
                  const Spacer(),
                  Semantics(
                    label: AppLocalizations.of(context)!.termsRemoveLink,
                    button: true,
