...
const kBasicTextAlt = TextStyle(color: kDarkBlue, fontWeight: FontWeight.bold, fontSize: 66, );
const kBackgroundTint = Color.fromRGBO(236, 242, 249, 1.0);
const kDarkBlue = Color.fromRGBO(0, 26, 51, 1.0);
//const kShadowDarkBlue = Color.fromRGBO(0, 26, 51, 0.4);
...
const kAlertTitleText = TextStyle(color: Colors.white, fontWeight: FontWeight.w300, fontSize: 22);
const kLanguageHeaderText = TextStyle(color: kDarkBlue, fontSize: 16, letterSpacing: 0.1, fontFamily: 'Inter', fontWeight: FontWeight.w900);